    ...
    return (
      ...
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
        ...
        <div className='flex justify-center space-x-4 mt-2'>
          <button onClick={'handleGoogleSignIn'} aria-label='Log in with Google' className='rounded-sm py-2 border-2 border-secondary flex items-center gap-4 w-full justify-center font-bold'>
            <svg
